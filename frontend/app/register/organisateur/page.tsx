...
const TYPE_STRUCTURE_OPTIONS: { value: TypeStructure; label: string }[] = [
  { value: 'COLLEGE_LYCEE', label: 'Collège ou lycée' },
  { value: 'ECOLE_PRIMAIRE', label: 'École primaire ou maternelle' },
...
const isStructureScolaire = (t: TypeStructure | '') => t === 'COLLEGE_LYCEE' || t === 'ECOLE_PRIMAIRE';

function RegisterOrganisateurContent() {
    ...
    <main className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Inscription organisateur de séjour</h1>
          <p className="mt-1 text-sm text-gray-500">Que vous soyez enseignant, responsable d&apos;association, agent de mairie ou directeur de centre de loisirs, créez votre compte gratuit pour organiser vos séjours collectifs.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-0.5">Votre établissement scolaire</label>
            ...
            <button type="submit" disabled={isPending || !typeStructure}
...
export default function RegisterOrganisateurPage() {
  return (
    <Suspense>
      <RegisterOrganisateurContent />
    </Suspense>
  );
}
