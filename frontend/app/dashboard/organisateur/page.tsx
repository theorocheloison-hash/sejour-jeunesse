    ...
    <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
      <div className="p-5 flex flex-col sm:flex-row sm:items-start gap-4">
        ...
        <div className="flex shrink-0 gap-2 flex-wrap items-center">
          {/* Bouton modifier — uniquement pour DRAFT */}
          {sejour.statut === 'DRAFT' && (
            <Link
              href={`/dashboard/organisateur/sejours/${sejour.id}/modifier`}
              className="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2"
            >
          ...
          {sejour.statut === 'DRAFT' && sejour.demandes && sejour.demandes.length > 0 && (() => {
            ...
            return (
              <div className="flex items-center gap-2">
                ...
                {totalDevis > 0 && (
                  <Link
                    href={`/dashboard/organisateur/sejours/${sejour.id}/offres`}
    ...
    <div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginBottom: 24 }}>
          ...
          <a href="/dashboard/organisateur/nouveau-sejour"
            style={{
              display: 'flex', flexDirection: 'column', gap: 4,
              padding: '16px 24px', borderRadius: 'var(--radius-lg)',
              border: '0.5px solid var(--color-border)',
          ...
          <a href="/dashboard/organisateur/demandes"
            style={{
              display: 'flex', flexDirection: 'column', gap: 4,
              padding: '16px 24px', borderRadius: 'var(--radius-lg)',
              border: '0.5px solid var(--color-border)',
        ...
        {sejours.length > 0 ? (
          ...
          <div className="rounded-2xl border-2 border-dashed border-gray-200 bg-white py-16 text-center">
            ...
            <a
              href="/dashboard/organisateur/nouveau-sejour"
              style={{
