      ...
      <main className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Link href="/dashboard/venue/devis" className="group bg-white rounded-2xl border border-gray-200 shadow-sm px-5 py-4 hover:border-[var(--color-primary)] hover:shadow-md transition-all">
              ...
              <p className="text-sm font-semibold text-gray-900 group-hover:text-[var(--color-primary)]">Devis envoyés</p>
              <p className="text-xs text-gray-500 mt-0.5">Suivez vos propositions en cours</p>
            </Link>
            ...
            <Link href="/dashboard/venue/devis" className="group bg-white rounded-2xl border border-gray-200 shadow-sm px-5 py-4 hover:border-[var(--color-primary)] hover:shadow-md transition-all">
              <div className="flex items-start justify-between mb-3">
                ...
                {acomptesAttente > 0 && (
                  <span className="rounded-full bg-green-500 px-2 py-0.5 text-xs font-bold text-white">{acomptesAttente}</span>
                )}
              </div>
              <p className="text-sm font-semibold text-gray-900 group-hover:text-[var(--color-primary)]">Facturation</p>
              <p className="text-xs text-gray-500 mt-0.5">Acomptes et factures Chorus Pro</p>
            </Link>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { href: '/dashboard/venue/disponibilites', label: 'Disponibilités', desc: 'Périodes d\'accueil', icon: 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5', color: 'text-blue-500 bg-blue-50' },
