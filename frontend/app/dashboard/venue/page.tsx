    ...
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      <main className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            { label: 'S\u00e9jours en convention', value: sejoursConvention.length, color: 'text-[var(--color-primary)]', icon: 'M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21', tooltip: 'S\u00e9jours r\u00e9serv\u00e9s directement depuis votre catalogue, sans appel d\u2019offres' },
            { label: 'Devis en attente', value: devisEnAttente, color: 'text-orange-600', icon: 'M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z', tooltip: 'Devis envoy\u00e9s aux enseignants en attente de leur r\u00e9ponse' },
            { label: 'Devis retenus', value: devisSelectionnes, color: 'text-green-600', icon: 'M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z', tooltip: 'Devis s\u00e9lectionn\u00e9s par les enseignants \u2014 s\u00e9jours confirm\u00e9s via appel d\u2019offres' },
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            {/* Clients */}
            <Link href="/dashboard/venue/clients" className="group bg-white rounded-2xl border border-gray-200 shadow-sm px-5 py-4 hover:border-[var(--color-primary)] hover:shadow-md transition-all">
              <div className="flex items-start justify-between mb-3">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-gray-400 text-center pt-1">
                  ...
                  <Link href="/dashboard/venue/planning" className="text-[var(--color-primary)] hover:underline">
                    Planning
                  </Link>
                </p>
              </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              ...
              { href: '/dashboard/venue/inviter-enseignant', label: 'Inviter', desc: 'Proposer un séjour', icon: 'M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM3 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 019.374 21c-2.331 0-4.512-.645-6.374-1.766z', color: 'text-[var(--color-primary)] bg-blue-50' },
            ].map((item) => (
