...
import PlanningPDF, { type PlanningPDFProps } from './PlanningPDF';
...
export default function PlanningPDFButton({ planningProps, filename = 'planning.pdf' }: PlanningPDFButtonProps) {
  ...
  // Pas de cache du blobUrl : le planning mute (glisser-déposer, resize) — un blob
  // caché serait périmé après modification. Régénération à chaque clic (volume faible).
