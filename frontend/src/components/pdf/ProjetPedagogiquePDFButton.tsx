...
import type { ProjetPedagogiqueData } from './ProjetPedagogiquePDF';

export type { ProjetPedagogiquePDFProps, ProjetPedagogiqueData } from './ProjetPedagogiquePDF';
...
export default function ProjetPedagogiquePDFButton({ data, objectifsPedago, lienProgrammes, filename = 'projet-pedagogique.pdf' }: ProjetPedagogiquePDFButtonProps) {
  ...
  const generate = async (): Promise<string> => {
    ...
    const { default: ProjetPedagogiquePDF } = await import('./ProjetPedagogiquePDF');
