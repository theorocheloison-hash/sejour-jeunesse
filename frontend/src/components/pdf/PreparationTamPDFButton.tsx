...
export type { PreparationTamPDFProps } from './PreparationTamPDF';

interface PreparationTamPDFButtonProps {
  data: DossierPedagogiqueData;
  sejourId: string;
}

export default function PreparationTamPDFButton({ data, sejourId }: PreparationTamPDFButtonProps) {
  ...
  const generate = async (): Promise<string> => {
    ...
    const { default: PreparationTamPDF } = await import('./PreparationTamPDF');
