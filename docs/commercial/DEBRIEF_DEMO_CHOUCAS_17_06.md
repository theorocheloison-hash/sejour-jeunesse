# Débrief démo Les Choucas — 17 juin 2026

## Contexte
- **Centre** : Centre de vacances Le Choucas, Sixt-Fer-à-Cheval (74)
- **Interlocuteurs** : Anne Cheignon (directrice), Nora (directrice adjointe)
- **Lieu** : au Sauvageon, en personne
- **Durée** : ~1h
- **Source lead** : premier contact inbound LinkedIn

## Résultat
**PREMIER CLIENT SIGNÉ.** Inscription immédiate via invitation admin, 2 mois gratuits puis plan Complet payant.

## Retours
- L'outil couvre 90% de leurs besoins
- Agréablement surprises par : devis, facturation, suivi des paiements, espace collaboratif séjours, catalogue, suivi factures en attente
- Souhaitent que ça passe par la centrale LMDJ pour tout centraliser
