...
> **Dernière mise à jour : 08/07/2026 (suite)** — Chantier 10.1 (abonnements virement / protection Choucas) livré de bout en bout : deadline 26/09 NEUTRALISÉE (cron exclut les VIREMENT + Choucas marqué), facture échéance/mention dynamiques, activation admin atomique + badge Paiement, relance J-30 virement, self-service +14j. Edge cases onboarding soldés (a/b déjà corrects, c fixé : pied checklist sur `envoisBloques`). Compte de test 08/07 neutralisé. Matin : onboarding phase 2 (§10.11) + 3 bugs smoke-test corrigés. Voir §10 + SESSION_STATE 08/07.
