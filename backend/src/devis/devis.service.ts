...
export class DevisService {
  ...
  async create(dto: CreateDevisDto, userId: string, file?: Express.Multer.File, centreId?: string | null) {
    ...
    // supprimés) : l'envoi est un geste MANUEL de l'hébergeur (envoyerDevis).
    ...
    // Log CRM non bloquant — la création ne vaut plus envoi (trace de soumission seule)
    try {
      ...
      include: {
          ...
          include: {
            ...
            sejour: {
              select: {
                ...
                heureArrivee: true, heureDepart: true, transportAller: true, transportSurPlace: true, activitesSouhaitees: true, budgetMaxParEleve: true, noteDateFlexible: true,
                clientNom: true, clientPrenom: true, clientEmail: true, clientTelephone: true, clientOrganisation: true, clientAdresse: true, clientCodePostal: true, clientVille: true,
              },
            },
          },
        ...
        sejourDirect: {
          select: {
            ...
            niveauClasse: true, heureArrivee: true, heureDepart: true, transportAller: true, transportSurPlace: true, activitesSouhaitees: true, budgetMaxParEleve: true, noteDateFlexible: true,
          },
        },
      },
    });
  ...
  async updateDevis(id: string, dto: UpdateDevisDto, userId: string, file?: Express.Multer.File, centreId?: string | null) {
    ...
    // Plus de notification automatique de modification : l'hébergeur renvoie
    // le devis manuellement s'il veut prévenir (envoyerDevis).
      ...
      include: {
        ...
        sejour: {
          select: {
            ...
            heureDepart: true,
            transportAller: true,
            transportSurPlace: true,
            activitesSouhaitees: true,
            budgetMaxParEleve: true,
            noteDateFlexible: true,
            clientNom: true,
            clientPrenom: true,
            clientEmail: true,
